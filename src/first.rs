...
#[derive(Debug, Clone)]
pub struct FirstSet {
    /// Whether the non-terminal generates empty string
    empty: bool,

    /// Set of terminals that the strings generated by the non-terminal start with
    terminals: Set<TerminalIdx>,
}
...
impl FirstSet {
    ...
    pub fn terminals(&self) -> &Set<TerminalIdx> {
        &self.terminals
    }
